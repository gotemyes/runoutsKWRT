...
def total_partnership_scrape_test():
...
def total_partnership_scrape_odi():

    ## scrape data for highest test partnerships (aggregate) from espncricinfo
    url = 'https://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;template=results;type=fow'
    website = requests.get(url)
    soup = BeautifulSoup(website.content,'html.parser')
    data=[]
    idDict = {}
    ...
    df.to_csv(f'../data/top{len(df)}ODIPartnerships.csv')

def total_partnership_scrape_t20i():

    ## scrape data for highest test partnerships (aggregate) from espncricinfo
    url = 'https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;template=results;type=fow'
    website = requests.get(url)
    soup = BeautifulSoup(website.content,'html.parser')
    data=[]
    idDict = {}
    ...
    df.to_csv(f'../data/top{len(df)}T20IPartnerships.csv')

def total_partnership_scrape_all():

    ## scrape data for highest test partnerships (aggregate) from espncricinfo
    url = 'https://stats.espncricinfo.com/ci/engine/stats/index.html?class=11;template=results;type=fow'
    website = requests.get(url)
    soup = BeautifulSoup(website.content,'html.parser')
    data=[]
    idDict = {}
    ...
    df.to_csv(f'../data/top{len(df)}AllPartnerships.csv')

if __name__ == '__main__':
    total_partnership_scrape_test()
    total_partnership_scrape_odi()
    total_partnership_scrape_t20i()
    total_partnership_scrape_all()
